...
@SpringBatchTest
@SpringBootTest
class PartitionedDailyVideoAggregationJobTest {
    @Autowired
    ...
    @Autowired
    @Qualifier(PartitionedDailyVideoAggregationJobConfig.JOB_NAME)
    private Job partitionedDailyVideoAggregationJob;

    @BeforeEach
    void setUp() {
        jobLauncherTestUtils.setJob(partitionedDailyVideoAggregationJob);
    }
